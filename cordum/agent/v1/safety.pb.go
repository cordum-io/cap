...
//
// Values 6 and 7 (QUARANTINE, REDACT) were appended for the unified
// Policy Studio Rule/Decision/Bundle shapes (Cordum epic-d9a6c0a1).
// Per CAP append-only rule: existing values 0-5 retain their numbers.
...
const (
	...
	DecisionType_DECISION_TYPE_QUARANTINE             DecisionType = 6
	DecisionType_DECISION_TYPE_REDACT                 DecisionType = 7
)
...
var (
	DecisionType_name = map[int32]string{
		...
		6: "DECISION_TYPE_QUARANTINE",
		7: "DECISION_TYPE_REDACT",
	}
...
type PolicyCheckRequest struct {
	...
	// Original size of the full input payload in bytes.
	// Set even when input_content is truncated at the size cap.
...
func (x *PolicyCheckRequest) GetInputContent() []byte {
	if x != nil {
...
func (x *PolicyCheckRequest) GetInputContentType() string {
	if x != nil {
...
func (x *PolicyCheckRequest) GetInputSizeBytes() int64 {
	if x != nil {
...
const file_cordum_agent_v1_safety_proto_rawDesc = "" +
	...
	"$DECISION_TYPE_ALLOW_WITH_CONSTRAINTS\x10\x05\x12\x1c\n" +
	"\x18DECISION_TYPE_QUARANTINE\x10\x06\x12\x18\n" +
	"\x14DECISION_TYPE_REDACT\x10\a2\xc6\x03\n" +
	"\fSafetyKernel\x12R\n" +

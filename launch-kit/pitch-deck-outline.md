...
1) Title: “Cortex Agent Protocol (CAP) — Open Control Plane for Distributed AI”
...
5) Product: Spec + Protos; Reference Implementation = CortexOS; SDKs (Go/Python/TS) roadmap.
...
10) Business: CortexOS Cloud as managed CAP control plane; support/certification.

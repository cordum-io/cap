...
- **Deterministic Encoding:** Signatures MUST be computed over deterministic protobuf serialization. Map entries MUST be ordered by key so all SDKs produce identical bytes for verification.
